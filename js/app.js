  ...
  (0, _jquery2.default)(window).on("load resize", function () {
    if (window.innerWidth < 900) {
      (0, _jquery2.default)(".about-block").each(function () {
        (0, _jquery2.default)(this).find(".about-block__holder").prepend((0, _jquery2.default)(this).find(".about-block__title"));
      });
    } else {
      (0, _jquery2.default)(".about-block").each(function () {
...
exports.default = function () {
    (0, _jquery2.default)('.results-slider').slick({
        slidesToShow: 3,
        slidesToScroll: 1,
        variableWidth: true,
        centerMode: true,
    ...
    (0, _jquery2.default)('.about-block__slider').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        dots: true,
        asNavFor: '.about-block__slider-nav'
    });
    (0, _jquery2.default)('.about-block__slider-nav').slick({
        slidesToShow: 1,
        slidesToScroll: 1,
        fade: true,
        asNavFor: '.about-block__slider'
    });
};
