...
exports.default = ["dev", "brand-page.html", "cart-empty.html", "cart.html", "category-brand.html", "category-hub-european.html", "category-hub-real-swords.html", "category.html", "contact-sent.html", "contact.html", "index.html", "product-with-fields.html", "product.html", "shipping.html"];
...
exports.default = function () {
  ...
  if (window.innerWidth < 901) {
    (0, _jquery2.default)(".category-page-types-list").slick({
      slidesToShow: 3,
      centerMode: true,
      infinite: false,
      slidesToScroll: 1,
  ...
  (0, _jquery2.default)(".header-cart-products").on("afterChange init", function (slick, currentSlide) {
    (0, _jquery2.default)(".header-cart-products__count").text(currentSlide.currentSlide + 1 + "/" + currentSlide.slideCount);
  });
